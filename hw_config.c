...
void Set_System(void)
{
	...
	ADC_RegularChannelConfig(ADC2, ADC_Channel_3, 2, ADC_SampleTime_71Cycles5);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_4, 3, ADC_SampleTime_71Cycles5);
	ADC_RegularChannelConfig(ADC2, ADC_Channel_5, 3, ADC_SampleTime_71Cycles5);
